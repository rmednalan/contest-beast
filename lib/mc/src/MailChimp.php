...
class MailChimp
{
    ...
    */
	...
	public function apiKeyValidate(){
		//construnct the url
		//https://us16.api.mailchimp.com/3.0/?apikey=1969d02ecd49110d87964dbce50d2251-us16
		
		$url = $this->api_endpoint."/?apikey=".$this->api_key;
		...
		if ($url!=""){
			...
			$mc_account = json_decode($head, true);
			/* echo $mc_account['login_id'];
			print_r($mc_account); */
