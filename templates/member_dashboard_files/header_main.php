...
<html lang="en">
  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color:#333 !important;">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo get_page_link(9); ?>"><span class="glyphicon glyphicon-fire"></span> Contest Buzz Dashboard</a>
        </div>
        <div class="navbar-collapse collapse" style="font-size: 12px;padding-right: 30px;">
          <ul class="nav navbar-nav">
            <li><a href="<?php echo get_page_link(9); ?>"><span class="glyphicon glyphicon-stats"></span> My Contests</a></li>
            <li><a href="<?php echo get_page_link(1422); ?>"><span class="fa fa-plus"></span> New Contest</a></li>
            <li><a href="<?php echo get_page_link(1425); ?>"><span class="glyphicon glyphicon-plus-sign"></span> Contest University</a></li>
            <li><a href="<?php echo get_page_link(53); ?>"><span class="glyphicon glyphicon-briefcase"></span> Support</a></li>          
          </ul>          
